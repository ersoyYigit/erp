...
namespace ArdaManager.Application.Interfaces.Repositories
{
    ...
    /// </summary>
    public interface IVappRepository
    {
        /// <summary>
        ...
        /// <summary>
        /// This method takes <see cref="AuditableEntity{TPrimaryKey}"/> and performs entity insert operation. In additional this methods returns <see cref="{TEntity}"/>
        /// </summary>
        /// <typeparam name="TEntity">
        /// Type of Entity
        /// </typeparam>
        ...
        /// Returns <see cref="{TEntity}"/>
        /// </returns>
        TEntity Add<TEntity, TPrimaryKey>(TEntity entity) where TEntity : AuditableEntity<TPrimaryKey>;

        /// <summary>
        /// This method takes <see cref="AuditableEntity{TPrimaryKey}"/> and performs entity insert operation async version. In additional this methods returns <see cref="Task{TEntity}"/>
        /// </summary>
        /// <typeparam name="TEntity">
        /// Type of Entity
        /// </typeparam>
        ...
        /// <param name="cancellationToken"> A <see cref="CancellationToken"/> to observe while waiting for the task to complete.</param>
        /// <returns></returns>
        Task<TEntity> AddAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : AuditableEntity<TPrimaryKey>;
        ...
        /// <summary>
        /// This method takes <see cref="IEnumerable{AuditableEntity{TPrimaryKey}}"/> and performs entity insert range operation. In additional this methods returns <see cref="IEnumerable{TEntity}"/>
        /// </summary>
        /// <typeparam name="TEntity">
        /// Type of Entity
        /// </typeparam>
        ...
        /// Returns <see cref="IEnumerable{TEntity}"/>
        /// </returns>
        IEnumerable<TEntity> AddRange<TEntity, TPrimaryKey>(IEnumerable<TEntity> entities) where TEntity : AuditableEntity<TPrimaryKey>;

        /// <summary>
        /// This method takes <see cref="IEnumerable{AuditableEntity{TPrimaryKey}}"/> and performs entity insert range operation. In additional this methods returns <see cref="Task{IEnumerable{TEntity}}"/>
        /// </summary>
        /// <typeparam name="TEntity">
        /// Type of Entity
        /// </typeparam>
        ...
        /// Returns <see cref="Task{IEnumerable{TEntity}}"/>
        /// </returns>
        Task<IEnumerable<TEntity>> AddRangeAsync<TEntity, TPrimaryKey>(IEnumerable<TEntity> entites, CancellationToken cancellationToken = default) where TEntity : AuditableEntity<TPrimaryKey>;
        ...
        /// The entity to be deleted
        /// </param>
        void HardDelete<TEntity, TPrimaryKey>(TEntity entity) where TEntity : AuditableEntity<TPrimaryKey>;

        /// <summary>
        /// This method takes <see cref="{TEntity}"/> and performs hard delete operation async version for AuditableEntity. In additional this method returns <see cref="Task"/>
        /// </summary>
        /// <typeparam name="TEntity">
        /// Type of Entity
        /// </typeparam>
        ...
        /// Returns <see cref="Task"/>
        /// </returns>
        Task HardDeleteAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : AuditableEntity<TPrimaryKey>;
        ...
        /// PK of Entity
        /// </param>
        void HardDelete<TEntity, TPrimaryKey>(TPrimaryKey id) where TEntity : AuditableEntity<TPrimaryKey>;
        ...
        /// Returns <see cref="Task"/>
        /// </returns>
        Task HardDeleteAsync<TEntity, TPrimaryKey>(TPrimaryKey id, CancellationToken cancellationToken = default) where TEntity : AuditableEntity<TPrimaryKey>;
        ...
        /// PK of Entity
        /// </param>
        void SoftDelete<TEntity, TPrimaryKey>(TEntity entity) where TEntity : AuditableEntity<TPrimaryKey>;
        ...
        /// Returns <see cref="Task"/>
        /// </returns>
        Task SoftDeleteAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : AuditableEntity<TPrimaryKey>;
        ...
        /// PK of Entity
        /// </param>
        void SoftDelete<TEntity, TPrimaryKey>(TPrimaryKey id) where TEntity : AuditableEntity<TPrimaryKey>;
        ...
        /// Returns <see cref="Task"/>
        /// </returns>
        Task SoftDeleteAsync<TEntity, TPrimaryKey>(TPrimaryKey id, CancellationToken cancellationToken = default) where TEntity : AuditableEntity<TPrimaryKey>;
        ...
        /// <summary>
        /// This method takes <see cref="{TEntity}"/> and <see cref="{TPrimaryKey}"/>. This method performs update operation for AuditableEntity. In additional this method returs <see cref="{TEntity}"/>
        /// </summary>
        /// <typeparam name="TEntity">
        /// Type of Entity
        /// </typeparam>
        ...
        /// Returns <see cref="{TEntity}"/>
        /// </returns>
        TEntity Update<TEntity, TPrimaryKey>(TEntity entity) where TEntity : AuditableEntity<TPrimaryKey>;

        /// <summary>
        /// This method takes <see cref="{TEntity}"/> and <see cref="{TPrimaryKey}"/>. This method performs update operation for AuditableEntity. In additional this method returs <see cref="Task{TEntity}"/>
        /// </summary>
        /// <typeparam name="TEntity">
        /// Type of Entity
        /// </typeparam>
        ...
        /// Returns <see cref="Task{TEntity}"/>
        /// </returns>
        Task<TEntity> UpdateAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : AuditableEntity<TPrimaryKey>;

        /// <summary>
        /// This method takes <see cref="IEnumerable{TEntity}"/> and <see cref="{TPrimaryKey}"/>. This method performs update range operation for AuditableEntity. In additional this method returs <see cref="IEnumerable{TEntity}"/>
        /// </summary>
        /// <typeparam name="TEntity">
        /// Type of Entity
        /// </typeparam>
        ...
        /// Returns <see cref="{TEntity}"/>
        /// </returns>
        IEnumerable<TEntity> UpdateRange<TEntity, TPrimaryKey>(IEnumerable<TEntity> entities) where TEntity : AuditableEntity<TPrimaryKey>;

        /// <summary>
        /// This method takes <see cref="IEnumerable{TEntity}"/> and <see cref="{TPrimaryKey}"/>. This method performs update operation for AuditableEntity. In additional this method returs <see cref="Task{TResult}"/>
        /// </summary>
        /// <typeparam name="TEntity">
        /// Type of Entity
        /// </typeparam>
        ...
        /// Returns <see cref="Task{TResult}"/>
        /// </returns>
        Task<IEnumerable<TEntity>> UpdateRangeAsync<TEntity, TPrimaryKey>(IEnumerable<TEntity> entities, CancellationToken cancellationToken = default) where TEntity : AuditableEntity<TPrimaryKey>;
        ...
        /// <summary>
        /// This method takes <see cref="{TEntity}"/> and <see cref="{TPrimaryKey}"/>. This method performs replace operation for AuditableEntity. In additional this method returs <see cref="{TEntity}"/>
        /// </summary>
        /// <typeparam name="TEntity">
        /// Type of Entity
        /// </typeparam>
        ...
        /// Returns <see cref="{TEntity}"/>
        /// </returns>
        TEntity Replace<TEntity, TPrimaryKey>(TEntity entity) where TEntity : AuditableEntity<TPrimaryKey>;

        /// <summary>
        /// This method takes <see cref="{TEntity}"/> and <see cref="{TPrimaryKey}"/>. This method performs replace operation for AuditableEntity. In additional this method returs <see cref="Task{TEntity}"/>
        /// </summary>
        /// <typeparam name="TEntity">
        /// Type of Entity
        /// </typeparam>
        ...
        /// Returns <see cref="Task{TEntity}"/>
        /// </returns>
        Task<TEntity> ReplaceAsync<TEntity, TPrimaryKey>(TEntity entity, CancellationToken cancellationToken = default) where TEntity : AuditableEntity<TPrimaryKey>;
