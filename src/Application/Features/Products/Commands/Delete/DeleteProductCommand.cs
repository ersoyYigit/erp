...
namespace ArdaManager.Application.Features.Products.Commands.Delete
{
    ...
    internal class DeleteProductCommandHandler : IRequestHandler<DeleteTemplateCommand, Result<int>>
    {
