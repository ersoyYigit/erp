...
using ArdaManager.Application.Features.DocumentTypes.Commands.Delete;
using ArdaManager.Application.Features.DocumentTypes.Queries.Export;
...
namespace ArdaManager.Server.Controllers.Utilities.Misc
{
