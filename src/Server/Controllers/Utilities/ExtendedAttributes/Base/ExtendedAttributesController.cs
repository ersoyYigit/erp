...
using ArdaManager.Application.Features.ExtendedAttributes.Commands.Delete;
...
using ArdaManager.Application.Features.ExtendedAttributes.Queries.GetById;
using ArdaManager.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace ArdaManager.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
