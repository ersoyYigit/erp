...
using ArdaManager.Client.Infrastructure.Managers.Catalog.ProductCategory;
using ArdaManager.Client.Infrastructure.Managers.Catalog;

namespace ArdaManager.Client.Pages.Catalog
{
    public partial class AddEditPatternModal
    {
        [Inject] private IPatternManager PatternManager { get; set; }

        [Parameter] public AddEditPatternCommand AddEditPatternModel { get; set; } = new();
        ...
        {
            var response = await PatternManager.SaveAsync(AddEditPatternModel);
