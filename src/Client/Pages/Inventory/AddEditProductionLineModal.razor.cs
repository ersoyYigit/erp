...
{
    public partial class AddEditProductionLineModal
    {
        [Inject] private IProductionLineManager ProductionLineManager { get; set; }

        [Parameter] public AddEditProductionLineCommand AddEditProductionLineModel { get; set; } = new();
        ...
        {
            var response = await ProductionLineManager.SaveAsync(AddEditProductionLineModel);
