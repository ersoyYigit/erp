...
{
    public partial class AddEditWarehouseModal
    {
        [Inject] private IWarehouseManager WarehouseManager { get; set; }

        [Parameter] public AddEditWarehouseCommand AddEditWarehouseModel { get; set; } = new();
        ...
        {
            var response = await WarehouseManager.SaveAsync(AddEditWarehouseModel);
