...
using ArdaManager.Infrastructure.Helpers;
...
using ArdaManager.Shared.Constants.User;
    ...
    public class DatabaseSeeder : IDatabaseSeeder
    {
        ...
        private void AddAdministrator()
        {
            Task.Run(async () =>
            {
                ...
                var adminRole = new VappRole(RoleConstants.AdministratorRole, _localizer["Administrator role with full permissions"]);
                ...
                var superUser = new VappUser
                {
                    FirstName = "Vapp",
                    LastName = "Admin",
                    Email = "admin@Vapp.com",
                    UserName = "admin",
                    EmailConfirmed = true,
        ...
        private void AddBasicUser()
        {
            ...
            {
                //Check if Role Exists
                var basicRole = new VappRole(RoleConstants.BasicRole, _localizer["Basic role with default permissions"]);
