...
{
    public abstract class AuditableContext : IdentityDbContext<VappUser, VappRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, VappRoleClaim, IdentityUserToken<string>>
    {
