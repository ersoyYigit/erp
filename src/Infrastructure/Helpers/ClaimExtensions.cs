...
namespace ArdaManager.Infrastructure.Helpers
{
    public static class ClaimsHelper
    {
        ...
        public static async Task<IdentityResult> AddPermissionClaim(this RoleManager<VappRole> roleManager, VappRole role, string permission)
        {
