...
namespace ArdaManager.Infrastructure.Services.Identity
{
    public class IdentityService : ITokenService
    {
        ...
        private readonly SignInManager<VappUser> _signInManager;
        private readonly IStringLocalizer<IdentityService> _localizer;

        public IdentityService(
            UserManager<VappUser> userManager, RoleManager<VappRole> roleManager,
            IOptions<AppConfiguration> appConfig, SignInManager<VappUser> signInManager,
        ...
        private async Task<string> GenerateJwtAsync(VappUser user)
        {
            var token = GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user));
            return token;
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(VappUser user)
        {
